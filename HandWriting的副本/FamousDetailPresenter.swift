...
import Foundation
import BothamUI
class FamousDetailPresenter: BothamPresenter {
    private let detailData: NSMutableDictionary
    private weak var ui: FamousDetailUI?
    
    init(ui: FamousDetailUI, detailData: NSMutableDictionary) {
        self.ui = ui
