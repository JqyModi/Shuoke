...
class StudyViewController: HandWritingViewController, BothamTableViewController, CommonUI {
    
    @IBOutlet var tableView: UITableView!
    var dataSource: BothamTableViewDataSource<Common, StudyTableViewCell>!
    ...
    override func viewDidLoad() {
        ...
        tableView.accessibilityLabel = "StudyTableView"
