...
protocol RegisterViewWithMobDelegate {
...
class RegisterViewWithMob: UIView {
    
    var loginDelegate: RegisterViewWithMobDelegate?
...
//        password?.isSecureTextEntry = true
        ...
        //点击事件
        code?.addTarget(self, action: #selector(RegisterViewWithMob.codeAction), for: .touchUpInside)
        ...
        //点击事件
        login?.addTarget(self, action: #selector(RegisterViewWithMob.loginAction), for: .touchUpInside)
        ...
        //点击事件
        close?.addTarget(self, action: #selector(RegisterViewWithMob.closeAction), for: .touchUpInside)
...
extension RegisterViewWithMob: UITextFieldDelegate {
