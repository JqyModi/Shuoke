...
private struct VConstants {
    ...
    static let TipLableText = "您还没有登录哦 ~ 请先登录，没有账号？请点击注册 ~ "
...
class VisitorLoginView: UIView {
    ...
    private lazy var tipLabel: UILabel = UILabel(title: VConstants.TipLableText, size: VConstants.TipLabelFontSize, color: .lightGray)
