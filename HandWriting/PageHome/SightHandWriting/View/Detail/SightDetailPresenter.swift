...
import Foundation
import BothamUI
class SightDetailPresenter: BothamPresenter {
    private let detailData: NSMutableDictionary
    private weak var ui: SightDetailUI?
    
    init(ui: SightDetailUI, detailData: NSMutableDictionary) {
        self.ui = ui
